...
function CheckoutModal() {
  return (
    <div className="fixed inset-0 z-10 hidden items-center justify-center">
      <div className="bg-white shadow-xl p-10 rounded-xl w-xl max-sm:w-[100%] max-sm:mx-10 max-sm:p-5">
        <Image src={ConfirmIcon} alt="Item" className="mb-5" />
