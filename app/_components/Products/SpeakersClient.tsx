...
function SpeakersClient({ speakers }: SpeakersProps) {
  return (
    <>
      {speakers.map((speaker, i) => (
        ...
        >
          <Image
            src={speaker?.gallery?.first?.desktop}
            quality={100}
            alt={speaker.name}
            width={500}
            height={500}
          ...
          />
          <Image
            src={speaker?.gallery?.first?.tablet}
            quality={100}
            alt={speaker.name}
            width={500}
            height={500}
          ...
          />
          <Image
            src={speaker?.gallery?.first?.mobile}
            quality={100}
            alt={speaker.name}
            width={500}
            height={500}
