...
import { SpeakersProps } from "@/app/types/speakers";
import { useParams } from "next/navigation";

function SpeakersDetails({ speakers }: SpeakersProps) {
  ...
  return (
    <div className="pt-40 pb-20 max-lg:py-10">
      ...
      {speakers
        .filter((speakers) => speakers.slug === productName)
        .map((speakers) => (
          <div key={speakers.name}>
            <div
            ...
            >
              ...
              />
              <Image
                src={speakers?.gallery?.first?.tablet}
                quality={100}
                alt={speakers.name}
                width={500}
                height={500}
              ...
              />
              <Image
                src={speakers?.gallery?.first?.mobile}
                quality={100}
                alt={speakers.name}
                width={500}
                height={500}
            ...
            <div className="flex justify-around gap-96 mt-52 px-32 max-xl:px-16 max-lg:flex-col max-lg:gap-36 max-lg:px-10 max-sm:mt-24">
              <div className="flex-1">
                ...
                <p className="text-[15px] text-gray-500">{speakers.features}</p>
              </div>
